...
{% image https://cdn.dusays.com/2019/08/50-1.jpg  ratio:1918/866 %}
...
这里可以使用网络地址转换实现。NAT 会将内网的地址转换为外网的地址，数据包返回后，目标地址指向边际路由，路由会将外网地址转换成内网的地址，再找到内网的目标终端。
...
{% image https://cdn.dusays.com/2019/08/50-2.jpg  ratio:1918/866 %}
