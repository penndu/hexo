...
> 那些认为 Linux 命令行单调无聊、毫无乐趣的人，你们错了！今天杜老师就为大家推荐一个小应用，让您感受一下 Linux 是如何的有趣！
...
注意：任何可以输出结果的命令，都可以通过管道符传输给 lolcat 来实现彩虹效果，管道符前的命令可随意替换。

## 使用效果

执行效果如下：

{% image https://cdn.dusays.com/2020/10/270-1.jpg  ratio:1918/866 %}