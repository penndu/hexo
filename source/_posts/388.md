...
{% gallery %}
![](https://cdn.dusays.com/2021/10/388-1.jpg/a)
{% endgallery %}

进入保存博文的目录 source/_posts：

{% gallery %}
![](https://cdn.dusays.com/2021/10/388-2.jpg/a)
{% endgallery %}

点击 Add file 添加一个新文件：

{% gallery %}
![](https://cdn.dusays.com/2021/10/388-3.jpg/a)
{% endgallery %}

填写文件名称：

{% gallery %}
![](https://cdn.dusays.com/2021/10/388-4.jpg/a)
{% endgallery %}

按照下图格式添加内容模板，并添加自己的内容：

{% gallery %}
![](https://cdn.dusays.com/2021/10/388-5.jpg/a)
{% endgallery %}

编辑好内容后，点击 Commit new file 提交并自动部署：

{% gallery %}
![](https://cdn.dusays.com/2021/10/388-6.jpg/a)
{% endgallery %}
