...
首先需要参照《[思科动态路由](https://dusays.com/posts/47/)》以及《[简单聊OSPF](https://dusays.com/posts/230/)》教程配置下图：Router0 和 Router1 使用动态路由，剩余路由使用 OSPF 协议，其中 Router2 和 Router3 的 Fa0/0 都属于 area 0，Router3 的 Fa0/1 口、Router4 和 Router5 都属于 area 1。
