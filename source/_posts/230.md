...
首先需要对照《[思科动态路由](https://dusays.com/archives/47/)》以及《[简单聊OSPF](https://dusays.com/archives/230/)》教程配置下图，Router0 和 Router1 使用的动态路由，剩下路由使用的 OSPF 协议，其中 Router2 和 Router3 的 Fa0/0 都是 area 0，Router3 的 Fa0/1 口、Router4 和 Router5 都是 area 1。
