...
No More Secrets 是一个简单的命令行工具，可重现 1992 年电影《Sneakers》中所见的著名数据解密效果。它能够与命令及管道数据一起使用，并以混乱字符的形式打印输出。

开始后按任意键，即可在输出中看到非常酷炫的好莱坞式现场解密效果。
...
{% image https://cdn.dusays.com/2020/10/269-1.jpg  ratio:1918/866 %}