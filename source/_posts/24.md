...
{% image https://cdn.dusays.com/2019/08/24-1.jpg  ratio:1918/866 %}
...
注意：两台交换设备命令相同。最后一行命令，只需在其中一台交换机执行即可，不需两台同时执行。执行后会自动同步到另一台交换机。

## 方案测试

测试效果如图：

{% image https://cdn.dusays.com/2019/08/24-2.jpg  ratio:1918/866 %}
...
{% image https://cdn.dusays.com/2019/08/24-3.jpg  ratio:1918/866 %}