...
{% image https://cdn.dusays.com/2019/08/46-1.jpg  ratio:1918/866 %}
...
所以如果想要 PC2 可以 Ping 通 PC1，必须告诉 Router0 路由器 192.168.3.0 的走向，并且因为需要回包，所以 Router1 路由器需要知道 192.168.1.0 的走向。
...
{% image https://cdn.dusays.com/2019/08/46-2.jpg  ratio:1918/866 %}
