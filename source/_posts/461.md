...
{% gallery %}
![](https://cdn.dusays.com/2022/05/461-1.jpg/a)
{% endgallery %}

映像约 800M 左右，下载好后启动。网络默认的 bridge 即可：

{% gallery %}
![](https://cdn.dusays.com/2022/05/461-2.jpg/a)
{% endgallery %}

下一步后，记得勾选启用自动重新启动：

{% gallery %}
![](https://cdn.dusays.com/2022/05/461-3.jpg/a)
{% endgallery %}

设置访问端口，如不设置，也可使用自动生成端口，对图床使用无影响：

{% gallery %}
![](https://cdn.dusays.com/2022/05/461-4.jpg/a)
{% endgallery %}

设置目录映射，将群晖本地文件夹映射到 `/var/www/html`，最后确认完成：

{% gallery %}
![](https://cdn.dusays.com/2022/05/461-5.jpg/a)
{% endgallery %}

通过浏览器打开该容器访问地址，在设置数据库时选择 SQLite 就可以了：

{% gallery %}
![](https://cdn.dusays.com/2022/05/461-6.jpg/a)
{% endgallery %}
