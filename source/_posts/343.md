...
{% image https://cdn.dusays.com/2021/05/343-1.jpg  ratio:1918/866 %}

## 我的配置

再来看下杜老师的电脑配置：

{% image https://cdn.dusays.com/2021/05/343-2.jpg  ratio:1918/866 %}
...
{% image https://cdn.dusays.com/2021/05/343-3.jpg  ratio:1918/866 %}

Windows 预览体验计划的提示信息：

{% image https://cdn.dusays.com/2021/05/343-4.jpg  ratio:1918/866 %}

## 信任模块

在网上各种搜索，大多都是说 TPM 没有开启，可以通过{% kbd WIN %}+{% kbd R %}打开运行框，输入 `tpm.msc` 打开下面的窗口，即可看到 TPM 的状态：

{% image https://cdn.dusays.com/2021/05/343-5.jpg  ratio:1918/866 %}
