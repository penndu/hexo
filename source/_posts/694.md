...
将下面代码按需修改后保存为 `docker-compose.yml`，然后执行 `docker-compose -f docker-compose.yml up -d` 即可创建并启动服务：
...
{% image https://cdn.dusays.com/2024/04/694-1.jpg  ratio:1918/866 %}

支持通过 API 监控服务状态：

{% image https://cdn.dusays.com/2024/04/694-2.jpg  ratio:1918/866 %}

可通过脚本调用在站内显示监控数据：

{% image https://cdn.dusays.com/2024/04/694-3.jpg  ratio:1918/866 %}

可直接在页面引用监控数据细节：

{% image https://cdn.dusays.com/2024/04/694-4.jpg  ratio:1918/866 %}

可在 GitHub 中直接创建事件：

{% image https://cdn.dusays.com/2024/04/694-5.jpg  ratio:1918/866 %}

监控数据支持各种调用方式：

{% image https://cdn.dusays.com/2024/04/694-6.jpg  ratio:1918/866 %}

部署完成后可通过 `http://IP:3000` 访问，支持反向代理：

{% image https://cdn.dusays.com/2024/04/694-7.jpg  ratio:1918/866 %}

支持浅色、深色模式切换：

{% image https://cdn.dusays.com/2024/04/694-8.jpg  ratio:1918/866 %}