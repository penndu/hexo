...
> 首先感谢下林木木童鞋，参考他的代码才有此篇教程。时光机的效果可以参考本博说说广场，不过时光机只会展示个人的说说，如需 Memos 的搭建教程，或是广场搭建教程，可以静等之后的教程！
...
<script src="https://jsd.dusays.com/npm/penndu@17.0.0/memos.js"></script>
<script src="https://jsd.dusays.com/npm/marked/marked.min.js"></script>
<script src="https://jsd.dusays.com/gh/Tokinx/ViewImage/view-image.min.js"></script>
<script src="https://jsd.dusays.com/gh/Tokinx/Lately/lately.min.js"></script>
```
...
{% image https://cdn.dusays.com/2023/03/561-1.jpg  ratio:1918/866 %}