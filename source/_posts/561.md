...
fetch(bbUrl).then(res=>res.json()).then(resdata=>{if(resdata.data){var allnums='<div id="bb-footer"><p class="bb-allpub"><a href="https://s.dusays.com/" target="_blank">杜老师的说说</a></p></div>'
