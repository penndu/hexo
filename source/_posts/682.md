...
> 为了方便小伙伴的使用，杜老师收集了常见平台的 APP。除正文中的安装包外，还有各主流浏览器插件，请有需要的小伙伴自行前往各浏览器应用商店下载，如需要代下载某歌浏览器的插件，可在评论区中留言。
...
Ubuntu/Debian/Linux Mint 等，但需注意不支持自动更新：

{% button 下载地址 https://penn.cowtransfer.com/s/32568c3f986d4c %}

Fedora/CentOS/RHEL/openSUSE 等，但需注意不支持自动更新：
