...
{% gallery %}
![](https://cdn.dusays.com/2021/11/407-1.jpg/a)
{% endgallery %}

上传从其它平台找到的皮肤文件，上传成功会有提示：

{% gallery %}
![](https://cdn.dusays.com/2021/11/407-2.jpg/a)
{% endgallery %}

回到游戏内输入指令`/skin update` 即可刷新皮肤：

{% gallery %}
![](https://cdn.dusays.com/2021/11/407-3.jpg/a)
{% endgallery %}

脱掉装备即可看到刷新后的皮肤效果：

{% gallery %}
![](https://cdn.dusays.com/2021/11/407-4.jpg/a)
{% endgallery %}
