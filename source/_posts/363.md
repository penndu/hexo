...
{% gallery %}
![](https://cdn.dusays.com/2021/07/363-1.jpg/a)
{% endgallery %}

指定‎需转换文件的位置，可以是.vhdx/.vmdk/.qcow2，支持本地、服务器或 SMB 共享上的 img 图像，并点击 Next：

{% gallery %}
![](https://cdn.dusays.com/2021/07/363-2.jpg/a)
{% endgallery %}

选 Local file‎‎ ‎选项，然后单击‎ Next 以继续：

{% gallery %}
![](https://cdn.dusays.com/2021/07/363-3.jpg/a)
{% endgallery %}

选择‎需转换的格式，然后单击‎‎ Next 以继续。可以是.vhdx/.vmdk/.qcow2/.img‎：

{% gallery %}
![](https://cdn.dusays.com/2021/07/363-4.jpg/a)
{% endgallery %}

如果转换为.vmdk，可选择动态存储或立即分配所有空间：

{% gallery %}
![](https://cdn.dusays.com/2021/07/363-5.jpg/a)
{% endgallery %}

设置转换文件存储路径，最后点‎‎ Next‎：‎

{% gallery %}
![](https://cdn.dusays.com/2021/07/363-6.jpg/a)
{% endgallery %}
