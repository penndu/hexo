...
{% gallery %}
![](https://cdn.dusays.com/2020/11/286-1.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/11/286-10.jpg/a)
{% endgallery %}

最后我们可以设置操作用户，Virtual Machine Manager 会根据之前配置生成一个清单，点击应用即可创建成功：

{% gallery %}
![](https://cdn.dusays.com/2020/11/286-11.jpg/a)
{% endgallery %}