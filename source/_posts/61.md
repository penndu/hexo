...
{% gallery %}
![](https://cdn.dusays.com/2019/09/61-1.jpg/a)
{% endgallery %}

这步不多说了，肯定要选同意，如果你有兴趣，可以看看协议内的内容：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-2.jpg/a)
{% endgallery %}

其实选典型就行了，不过为了让大家有更多选项可以学习，我们这里选自定义：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-3.jpg/a)
{% endgallery %}

这里可选择需要安装的服务，上面两个是必装的，第三个是增强键盘功能，第四个是个编程软件插件，下面可以修改程序安装地址：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-4.jpg/a)
{% endgallery %}

这里可以设置以后虚拟机的默认保存路径，下面可以设置 HTTPS 的默认端口：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-5.jpg/a)
{% endgallery %}

是否自动检测产品更新：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-6.jpg/a)
{% endgallery %}

选择这个程序就会定期匿名上传一些报告：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-7.jpg/a)
{% endgallery %}

新建快捷方式：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-8.jpg/a)
{% endgallery %}

所有都设置好，点击继续：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-9.jpg/a)
{% endgallery %}

这里需要输入产品的序列号，我们通过算号器算一个：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-10.jpg/a)
{% endgallery %}

复制到输入框。点击输入开始安装：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-11.jpg/a)
{% endgallery %}

到此安装完成：

{% gallery %}
![](https://cdn.dusays.com/2019/09/61-12.jpg/a)
{% endgallery %}