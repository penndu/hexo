...
脚本运行后选择安装监控 Agent，输入服务端的通信 IP 或者域名，例如：

```
nezha.dusays.com
```

输入服务端的通信端口，默认端口如下。之后再输入 Agent 密钥，Agent 密钥在管理面板添加服务器时生成，可以在管理面板的服务器页中找到：
...
{% image https://cdn.dusays.com/2024/11/766-1.jpg  ratio:1918/867 %}

可对各项服务状态进行监控，包括端口、网页、SSL 等：

{% image https://cdn.dusays.com/2024/11/766-2.jpg  ratio:1918/866 %}

可监控各主机网络状态，查看延迟：

{% image https://cdn.dusays.com/2024/11/766-3.jpg  ratio:1918/866 %}

支持多款主题切换，支持日间、夜间模式切换：

{% image https://cdn.dusays.com/2024/11/766-4.jpg  ratio:1918/866 %}