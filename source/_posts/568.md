...
{% image https://cdn.dusays.com/2023/03/568-1.jpg  ratio:1918/866 %}

输入社区地址前缀，如 `dubbs`，则访问的地址为 dubbs.freeflarum.com。邮箱的话确保可用，因为需要接收验证邮件：

{% image https://cdn.dusays.com/2023/03/568-2.jpg  ratio:1918/866 %}

域名后缀除了 freeflarum.com 外，还可以选择 flarum.cloud：

{% image https://cdn.dusays.com/2023/03/568-3.jpg  ratio:1918/866 %}

选择预设模板，三者默认启用插件不同「插件都是安装好的，只是根据模板启用插件不同」，大家也可以在后期自行配置，如果需要最小化安装建议选择 Minimal：

{% image https://cdn.dusays.com/2023/03/568-4.jpg  ratio:1918/866 %}

防机器人验证不用说了：

{% image https://cdn.dusays.com/2023/03/568-5.jpg  ratio:1918/866 %}
...
{% image https://cdn.dusays.com/2023/03/568-6.jpg  ratio:1918/866 %}

在 Account Settings 标签项中可以导出社区的数据，导出项含用户、帖子、文章、设置数据，注意不含附件：

{% image https://cdn.dusays.com/2023/03/568-7.jpg  ratio:1918/866 %}

## 社区访问

忘记说社区地址了，点击杜老师说导航处的社区即可：

{% image https://cdn.dusays.com/2023/03/568-8.jpg  ratio:1918/866 %}
...
最后社区的问题得到了解决，体验也进一步得到了改善，虽然不是最佳，不过大部分访问没什么问题！
