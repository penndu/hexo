...
首先将群晖设置为 UPS 服务器，当 UPS 的状态信息通过 USB 传输到群晖后，群晖可以通过网络将信息告知接收端。进入控制面板，进入硬件和电源，勾选"启动网络 UPS 服务器"，进入"允许的 Synology NAS 设备"，在 IP 地址处输入接收端的 IP 即可「确定后别忘了点右下方处的应用」

{% image https://cdn.dusays.com/2023/02/557-1.jpg  ratio:1918/866 %}
