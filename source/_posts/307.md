...
{% image https://cdn.dusays.com/2021/01/307-1.jpg  ratio:1918/866 %}

根据需求依次输入存储名称、备注描述、存储位置、存储容量、空间分配模式。这里的分配模式有两种，根据需求选择即可，如有不懂，可以在评论区留言同杜老师交流：

{% image https://cdn.dusays.com/2021/01/307-2.jpg  ratio:1918/866 %}

接下来设置 LUN 的 SAN 协议，默认即可：

{% image https://cdn.dusays.com/2021/01/307-3.jpg  ratio:1918/866 %}

设置存储访问权限，可以设置全部允许，也可指定主机：

{% image https://cdn.dusays.com/2021/01/307-4.jpg  ratio:1918/866 %}

最后确认设置即可：

{% image https://cdn.dusays.com/2021/01/307-5.jpg  ratio:1918/866 %}

结束向导后即可在页面中看到当前存储器状态：

{% image https://cdn.dusays.com/2021/01/307-6.jpg  ratio:1918/866 %}
