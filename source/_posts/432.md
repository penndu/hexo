...
注意：杜老师首先想到的是使用 yum update 更新，结果事与愿违，并没有版本的更新。

## 解决思路

在网上提供的升级方案，基本上都是先删除原来版本，然后在官网上下载最新版本，最后编译安装。编辑安装不仅麻烦，而且容易出错，无意中在网上看到一个 Git 软件源，在此分享一下使用方法：

```
vim /etc/yum.repos.d/wandisco-git.repo
```

首先输入上面命令新建配置文件，在配置文件中输入下面内容：
