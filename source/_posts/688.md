...
Flare 是一款轻量、快速、美观的个人导航页面，适用于 HomeLab 或其它注重私密的场景。
...
{% image https://cdn.dusays.com/2024/03/688-1.jpg  ratio:1918/866 %}

在 Flare 启动之后，您可以随时访问`/guide`，获取 Flare 基础界面功能的介绍：

{% image https://cdn.dusays.com/2024/03/688-2.jpg  ratio:1918/866 %}

为满足随时随地编辑的需求，程序新增了在线编辑的页面。地址是`/editor`：

{% image https://cdn.dusays.com/2024/03/688-3.jpg  ratio:1918/866 %}

为了减少不必要的地址记忆负担，程序新增一个帮助页面，默认展示所有程序内的工具页面。地址是`/help`：

{% image https://cdn.dusays.com/2024/03/688-4.jpg  ratio:1918/866 %}