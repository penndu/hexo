...
{% gallery %}
![](https://cdn.dusays.com/2020/06/233-1.jpg/a)
{% endgallery %}

找到 `browser.cache.check_doc_frequency` 选项双击将 `3` 改成 `1`：

{% gallery %}
![](https://cdn.dusays.com/2020/06/233-2.jpg/a)
{% endgallery %}

找到 `browser.cache.disk.enable` 选项把 `true` 改为 `false`：

{% gallery %}
![](https://cdn.dusays.com/2020/06/233-3.jpg/a)
{% endgallery %}

找到 `browser.cache.memory.enable` 选项把 `true` 改为 `false`：

{% gallery %}
![](https://cdn.dusays.com/2020/06/233-4.jpg/a)
{% endgallery %}
