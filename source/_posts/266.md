...
> 群晖 NAS 除了官方和第三方套件外，还可以自行添加套件源，以实现更多功能。今天杜老师教大家套件源的添加方法，并分享几个可用的源 URL！

<!-- more -->

## 添加方法

首先打开套件中心，点击右上角的设置，切换到「套件来源」选项卡，点击「添加」，名称处可留空，位置处从下面的套件源 URL 中任选一个复制过来，最后确认即可：

{% image https://cdn.dusays.com/2020/09/266-1.jpg  ratio:1918/866 %}
