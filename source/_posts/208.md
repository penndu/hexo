...
GNS3 是一款具有图形化界面、可跨平台运行的网络虚拟软件。Cisco 网络设备管理员或想要通过 CCNA/CCNP/CCIE 等 Cisco 认证考试的考生，都可以通过它来完成相关的实验模拟操作。同时它也可以用于虚拟体验 Cisco 网际操作系统 IOS，或是检验即将在真实路由器上部署实施的相关配置。

简单来说它是 Dynamips 的一个图形前端，相比直接使用 Dynamips 这样的虚拟软件要更容易上手，也更具可操作性。
