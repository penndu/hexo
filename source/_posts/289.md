...
{% gallery %}
![](https://cdn.dusays.com/2020/12/289-1.jpg/a)
{% endgallery %}

可在映像界面看到下载好的镜像，点击启动：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-2.jpg/a)
{% endgallery %}

可以设置容器名称，默认即可；AdGuard Home 无需高权限，且资源占用低。点击高级设置：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-3.jpg/a)
{% endgallery %}

为提高可用性，建议启用自动重新启动：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-4.jpg/a)
{% endgallery %}

然后进入到端口设置项，主要映射 3000/53 这两个端口。剩下端口可按需要映射，其中 443 用于 SSL 访问，67/68 用于 DHCP，80 用于 Web 访问，853 是加密型 DNS：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-5.jpg/a)
{% endgallery %}

设置好端口映射后，点击应用，接着会看到容器的配置页面，点击完成即可启动容器：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-6.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/12/289-7.jpg/a)
{% endgallery %}

首先设置网页管理页面以及 DNS 服务器，一般默认即可：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-8.jpg/a)
{% endgallery %}

为了避免他人恶意修改，AdGuard Home 支持管理员身份认证，输入管理员的账号密码进行设置：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-9.jpg/a)
{% endgallery %}

接下来是使用方法介绍，大致内容为将设备的 DNS 服务器设置为群晖 NAS 的 IP 地址就行了：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-10.jpg/a)
{% endgallery %}

初始设置都完成后，会弹出配置成功的页面，点击打开仪表盘即可看到 AdGuard Home 的主页面：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-11.jpg/a)
{% endgallery %}

最终效果如图：

{% gallery %}
![](https://cdn.dusays.com/2020/12/289-12.jpg/a)
{% endgallery %}