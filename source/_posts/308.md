...
{% gallery %}
![](https://cdn.dusays.com/2021/02/308-1.jpg/a)
{% endgallery %}

首次运行时会提示服务处于关闭状态，需要开启才可以继续使用该服务，点是：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-2.jpg/a)
{% endgallery %}

在弹出的 iSCSI 发起程序界面中找到目标，将群晖 NAS 访问地址，填在后面的输入框，然后点击快速连接：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-3.jpg/a)
{% endgallery %}

快速连接工具会自动连接到目标 iSCSI 上，并弹出已连接提示，点击完成：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-4.jpg/a)
{% endgallery %}

这时我们可以在之前的页面中看到已连接的 iSCSI，点击确认即可：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-5.jpg/a)
{% endgallery %}

进入到计算机管理界面，找到左侧存储——磁盘管理：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-6.jpg/a)
{% endgallery %}

点击进入后即可对挂载好的 iSCSI 进行初始化设置：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-7.jpg/a)
{% endgallery %}

之后可以根据需求，对其进行分区格式化等操作：

{% gallery %}
![](https://cdn.dusays.com/2021/02/308-8.jpg/a)
{% endgallery %}
