...
if (typeof Lately === 'undefined') {
  ...
  script.src = 'https://jsd.dusays.com/gh/Tokinx/Lately/lately.min.js';
  script.onload = () => {
...
```
<div id="bbs"></div>
<script type="text/javascript" src="https://jsd.dusays.com/npm/marked@4.3.0/marked.min.js"></script>
<script type="text/javascript" src="https://jsd.dusays.com/gh/Tokinx/ViewImage/view-image.min.js"></script>
<script type="text/javascript" src="https://jsd.dusays.com/gh/Tokinx/Lately/lately.min.js"></script>
```
