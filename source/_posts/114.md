...
> LVS 是 Linux Virtual Server 的简写，意即 Linux 虚拟服务器，是一个虚拟服务器集群系统。LVS 的实现模式常用的有三种，本篇介绍第三种——Tunnel 模式，常用于跨机房分发。
...
{% image https://cdn.dusays.com/2019/10/113-1.jpg  ratio:1918/866 %}
