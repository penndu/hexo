...
{% gallery %}
![](https://cdn.dusays.com/2021/08/370-1.jpg/a)
{% endgallery %}

然后选择游戏版本，懒人版中仅提供了 1.17 版，如果需要其它版本，可在评论区中留言：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-2.jpg/a)
{% endgallery %}

修改游戏昵称，然后启动游戏即可「如果进行线上游戏，一定要改名称，因为服务端是通过 ID 来判断用户身份」

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-3.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2021/08/370-4.jpg/a)
{% endgallery %}

在第二个界面选 Language：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-5.jpg/a)
{% endgallery %}

下拉列表，在最下端可以看到简体中文，选择并点击 Done 即可：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-6.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2021/08/370-7.jpg/a)
{% endgallery %}

首次进入多人游戏会有提示，这个无视即可，感觉麻烦可以勾选不再提示：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-8.jpg/a)
{% endgallery %}

在右下方会看到添加服务器：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-9.jpg/a)
{% endgallery %}

首次连接可能会有防火墙的警告，直接允许即可：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-10.jpg/a)
{% endgallery %}

在服务器地址输入连接地址，如 `mc.dusays.com:26295`：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-11.jpg/a)
{% endgallery %}

然后可在界面中看到杜老师的服务器状态，点击服务器名称前的箭头即可加入游戏中：

{% gallery %}
![](https://cdn.dusays.com/2021/08/370-12.jpg/a)
{% endgallery %}
