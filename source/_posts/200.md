...
{% gallery %}
![](https://cdn.dusays.com/2020/03/200-1.jpg/a)
{% endgallery %}

因为系统版本原因，这里只显示 IIS 一个选项，勾选后会提示如下：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-2.jpg/a)
{% endgallery %}

因为添加此项角色，需要依赖环境，所以要确认添加这些环境才可以安装：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-3.jpg/a)
{% endgallery %}

确认后会显示勾选成功：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-4.jpg/a)
{% endgallery %}

下图为 IIS 介绍：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-5.jpg/a)
{% endgallery %}

这里需要选择组件功能，根据需要勾选即可，这里我们默认：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-6.jpg/a)
{% endgallery %}

设置好后，就可以安装了：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-7.jpg/a)
{% endgallery %}

安装成功，显示如图：

{% gallery %}
![](https://cdn.dusays.com/2020/03/200-8.jpg/a)
{% endgallery %}