...
> rm 是 Linux 中用于删除文件的命令，它是非常强大却又非常危险的一条命令，特别是 rm -rf 有时候强大到让您欲哭无泪。
...
总之 `rm` 太危险了，特别是带有 `-rf` 参数时一定要慎之又慎，但老虎也有打盹的时候，所以为什么不给 `rm` 一剂后悔药呢？
...
{% image https://cdn.dusays.com/2019/09/58-1.jpg  ratio:1918/866 %}