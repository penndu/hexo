...
{% gallery %}
![](https://cdn.dusays.com/2021/11/405-1.jpg/a)
{% endgallery %}

再点击图床提卡系统进入到付费页面：

{% gallery %}
![](https://cdn.dusays.com/2021/11/405-2.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2021/11/405-10.jpg/a)
{% endgallery %}

使用刚刚获取的账号登录到去不图床：

{% gallery %}
![](https://cdn.dusays.com/2021/11/405-11.jpg/a)
{% endgallery %}

并强烈建议在第一时间修改账号密码。如果您对账号的用户名和邮箱不满意，可通过站长 QQ 联系到杜老师，我们将手动为您做调整：

{% gallery %}
![](https://cdn.dusays.com/2021/11/405-12.jpg/a)
{% endgallery %}
