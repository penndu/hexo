...
> Linux 系统有两种访问控制机制，其中一种是 DAC 自主访问控制，是 Linux 下默认的接入控制机制，通过控制对资源的读写与执行操作，保证系统安全。本文讲解 Linux 系统的权限管理相关命令。
...
| chmod o+t DIRNAME | 该目录添加 SBIT | 当一个目录设置 SBIT，该目录下文件仅所有者可以删除 |
