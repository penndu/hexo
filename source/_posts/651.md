...
{% image https://cdn.dusays.com/2023/11/651-1.jpg  ratio:1918/866 %}

上传后直接启用就行了，但需要先设置 Token 才可以使用：

{% image https://cdn.dusays.com/2023/11/651-2.jpg  ratio:1918/866 %}

如您使用去不图床托管，请在网址设置框输入 `https://7bu.top`，Tokens 框中输入在图床获取的 `TOKEN`，并可以选择是否要公开图片：

{% image https://cdn.dusays.com/2023/11/651-3.jpg  ratio:1918/866 %}

写文章时可在右侧看到插件模块，直接拖拽上传图片即可：

{% image https://cdn.dusays.com/2023/11/651-4.jpg  ratio:1918/866 %}
...
{% image https://cdn.dusays.com/2023/11/651-5.jpg  ratio:1918/866 %}

在正式使用前，需要先设置下。如您使用去不图床托管，请在网址设置框输入 `https://7bu.top`，Tokens 框中输入在图床获取的 `TOKEN`，存储 id 为空就行了：

{% image https://cdn.dusays.com/2023/11/651-6.jpg  ratio:1918/866 %}
