...
{% gallery %}
![](https://cdn.dusays.com/2020/02/190-1.jpg/a)
{% endgallery %}

然后进入磁盘管理：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-2.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/02/190-3.jpg/a)
{% endgallery %}

初始化后就会看到你的硬盘分区：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-4.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/02/190-5.jpg/a)
{% endgallery %}

点击菜单栏的操作，所有任务，点新建镜像卷，就会出现新建向导：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-6.jpg/a)
{% endgallery %}

左边框里是可以使用的硬盘，右边是已经选择的硬盘，需要点击左边框里硬盘，选择添加：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-7.jpg/a)
{% endgallery %}

硬盘添加之后，可以设置硬盘大小：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-8.jpg/a)
{% endgallery %}

这里是给硬盘分配盘符：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-9.jpg/a)
{% endgallery %}

是否要格式化硬盘，以及格式化的参数：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-10.jpg/a)
{% endgallery %}

配置完成，点击完成即可生效：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-11.jpg/a)
{% endgallery %}

新添加的硬盘一般都是基本磁盘，而要实现卷的创建，需要转换成动态磁盘才可以，点是即可：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-12.jpg/a)
{% endgallery %}

稍等一会，就可以在磁盘管理中看到了：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-13.jpg/a)
{% endgallery %}

最后我们去计算机确认一下，创建成功：

{% gallery %}
![](https://cdn.dusays.com/2020/02/190-14.jpg/a)
{% endgallery %}
