...
![](https://cdn.dusays.com/2021/01/301-1.jpg/a)
...
{% gallery %}
![](https://cdn.dusays.com/2021/01/301-2.jpg/a)
{% endgallery %}

接下来切换到映像界面，等待下载完成，之后选择刚刚下载好的映像，点击启动：

{% gallery %}
![](https://cdn.dusays.com/2021/01/301-3.jpg/a)
{% endgallery %}

在弹出的界面中选高级设置，然后切换到卷选项，通过添加文件夹的方式，加入如下设置：

{% gallery %}
![](https://cdn.dusays.com/2021/01/301-4.jpg/a)
{% endgallery %}

接着切换到端口设置项，按照图中所示进行设置：

{% gallery %}
![](https://cdn.dusays.com/2021/01/301-5.jpg/a)
{% endgallery %}

最后切换到环境项，按照图中所示进行设置，并在设置完成后点应用，启用容器即可：

{% gallery %}
![](https://cdn.dusays.com/2021/01/301-6.jpg/a)
{% endgallery %}
