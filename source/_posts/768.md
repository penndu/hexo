...
本文将详细介绍 X-CMD 的安装、基本使用及一些专业术语和功能特性。
...
{% image https://cdn.dusays.com/2024/11/768-1.jpg  ratio:1918/866 %}

增强版 `ls` 命令，可更方便地查看文件信息和系统信息：

{% image https://cdn.dusays.com/2024/11/768-2.jpg  ratio:1918/866 %}

查看进程，交互式查看 `ps` 数据：

{% image https://cdn.dusays.com/2024/11/768-3.jpg  ratio:1918/866 %}

该模块是使用 POSIX shell、`awk` 和 `find` 实现的增强版 `cd` 命令：

{% image https://cdn.dusays.com/2024/11/768-4.jpg  ratio:1918/866 %}

增强版 `stat` 命令，以 TUI 方式查看当前路径下所有文件的详细信息：

{% image https://cdn.dusays.com/2024/11/768-5.jpg  ratio:1918/866 %}

X-CMD 处理 PATH 变量，交互展示当前环境中 PATH 内二进制搜索目录：

{% image https://cdn.dusays.com/2024/11/768-6.jpg  ratio:1918/866 %}

增强型 `docker` 命令：

{% image https://cdn.dusays.com/2024/11/768-7.jpg  ratio:1918/866 %}

X-CMD 增强 `git` 命令：

{% image https://cdn.dusays.com/2024/11/768-8.jpg  ratio:1918/866 %}