...
{% gallery %}
![](https://cdn.dusays.com/2022/06/475-1.jpg/a)
{% endgallery %}

在弹出的窗口中输入备注名，如不想直接访问根目录，还可设置相对根目录的路径「需要注意的是，目录需要提前建好」

{% gallery %}
![](https://cdn.dusays.com/2022/06/475-2.jpg/a)
{% endgallery %}

上一步操作确定后，可看到平台自动生成的密码：

{% gallery %}
![](https://cdn.dusays.com/2022/06/475-3.jpg/a)
{% endgallery %}

切换到本地资源管理器，点击右键选择添加一个网络位置：

{% gallery %}
![](https://cdn.dusays.com/2022/06/475-4.jpg/a)
{% endgallery %}

一路下一步后，输入 WebDAV 的地址：

{% gallery %}
![](https://cdn.dusays.com/2022/06/475-5.jpg/a)
{% endgallery %}

根据提示输入登录名和密码「密码为上面平台自动生成的」

{% gallery %}
![](https://cdn.dusays.com/2022/06/475-6.jpg/a)
{% endgallery %}