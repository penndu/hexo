...
先前发布一篇名为《[在 Docker 中部署 Nextcloud](https://dusays.com/archives/88/)》教程，分享如何通过 Docker 快速部署 Nextcloud。
...
这里需要注意的是：因 Nextcloud 需要 PHP7.3 以上的版本，所以内存必须在 1G 以上。
...
{% image https://cdn.dusays.com/2023/02/556-1.jpg  ratio:1918/866 %}
...
{% image https://cdn.dusays.com/2023/02/556-2.jpg  ratio:1918/866 %}

安装后的界面展示：

{% image https://cdn.dusays.com/2023/02/556-3.jpg  ratio:1918/866 %}

文件浏览器的界面展示：

{% image https://cdn.dusays.com/2023/02/556-4.jpg  ratio:1918/866 %}

媒体界面展示：

{% image https://cdn.dusays.com/2023/02/556-5.jpg  ratio:1918/866 %}

动态界面展示：

{% image https://cdn.dusays.com/2023/02/556-6.jpg  ratio:1918/866 %}