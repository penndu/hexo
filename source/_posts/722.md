...
杜老师之前使用 GitLab，托管在群晖上，因 GitLab 体量较大，运行后会大量占用资源，影响群晖上其它套件使用。

奈何因托管的代码过多，迁移会占用大量时间，所以此事一直拖着未能解决。
...
简单易用界面，提供直观、友好的 Web 界面，方便用户进行代码管理、创建仓库、提交代码、查看历史记录等操作。
...
{% image https://cdn.dusays.com/2024/06/722-1.jpg  ratio:1918/866 %}

新版本 Gitea 支持 GitHub 同款 Actions，且支持相同的配置文件格式：

{% image https://cdn.dusays.com/2024/06/722-2.jpg  ratio:1918/866 %}

在仓库页可以查看提交数量、分支、仓库大小等等：

{% image https://cdn.dusays.com/2024/06/722-3.jpg  ratio:1918/866 %}

通过后台控制面板可以看到 Gitea 的运行情况，整理资源占用较小「于 GitLab 相比」

{% image https://cdn.dusays.com/2024/06/722-4.jpg  ratio:1918/866 %}