...
{% image https://cdn.dusays.com/2026/02/855-1.jpg  ratio:1918/866 %}

后台面板也很直白，不像大厂平台一样一堆操作接口：

{% image https://cdn.dusays.com/2026/02/855-2.jpg  ratio:1918/866 %}
...
本活动覆盖约 90% 的商品，少数特殊商品或叠加活动商品可能不可用；是否可用以结算页提示为准。

复制优惠码后进入选购页下单，在结算页输入即可使用；点击去选购会自动携带优惠码进入流程。

优惠码有效期至 2027 年 3 月 6 日，过期自动失效。
