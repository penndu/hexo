...
{% gallery %}
![](https://cdn.dusays.com/2020/07/241-1.jpg/a)
{% endgallery %}

如果提示需安装 Node.js，可按下篇教程操作：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-2.jpg/a)
{% endgallery %}

安装过程是自动的，等待即可：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-3.jpg/a)
{% endgallery %}

安装完成后建议重启 PicGo：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-4.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/07/241-5.jpg/a)
{% endgallery %}

回到 PicGo 主面板，点击图床设置，找到最下面 LskyPro Uploader，Url 输入 `https://7bu.top/api/upload`：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-6.jpg/a)
{% endgallery %}

Token 位置输入刚复制的值：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-7.jpg/a)
{% endgallery %}

最后点击确定即可，建议设置默认图床：

{% gallery %}
![](https://cdn.dusays.com/2020/07/241-8.jpg/a)
{% endgallery %}
