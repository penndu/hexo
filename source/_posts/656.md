...
开始部署之前，需要确保已经安装了 Docker。Docker 是一个开源的应用容器引擎，可以轻松地为任何应用程序创建一个轻量级、可移植、自给自足的容器。要安装 Docker，
...
{% image https://cdn.dusays.com/2023/12/656-1.jpg  ratio:1918/866 %}

管理员用户创建完成后，会自动跳转到登录页面，输入刚刚创建好的管理员账号后，可以看到如下页面，这时我们先点击 ADMINISTRATION 进入后台：

{% image https://cdn.dusays.com/2023/12/656-2.jpg  ratio:1918/866 %}

在后台面板中，我们首先汉化一下全站界面。点击左侧的 Locale，进入语言包设置页：

{% image https://cdn.dusays.com/2023/12/656-3.jpg  ratio:1918/866 %}

在右侧下载语言包，这里我们以 Chinese Simplified 为例，下载后在中间的 Site Localo 处选择 Chinese Simplified，最后点击右上角 APPLY 即可：

{% image https://cdn.dusays.com/2023/12/656-4.jpg  ratio:1918/866 %}

切换至首页后，即可创建主页内容。这里可以选择使用何种编辑器来创建，这里我们以 Markdown 为例：

{% image https://cdn.dusays.com/2023/12/656-5.jpg  ratio:1918/866 %}

在编辑内容前，我们还需要先设置页面属性，重点设置标题、路径，填写完成后点击右上角的 OK：

{% image https://cdn.dusays.com/2023/12/656-6.jpg  ratio:1918/866 %}

页面分级是通过标题级别实现的。这里我们就以二级标题为例，填写好内容后点击右上方的创建：

{% image https://cdn.dusays.com/2023/12/656-7.jpg  ratio:1918/866 %}

返回到主页后，即可看到相关内容。其它功能请伙伴们自行探索：

{% image https://cdn.dusays.com/2023/12/656-8.jpg  ratio:1918/866 %}
