...
1988 年乔布斯的 NeXT 公司获得了 Objective-C 这门编程语言的授权，并开发出了 Objective-C 语言库和 NeXTSTEP 的开发环境。后来苹果收购了 NeXT，乔布斯带着 NeXTSTEP 系统回归苹果，NeXTSTEP 成为了 macOS 的基础，发展越来越好，Objective-C 就成了苹果当家语言，现在基本上是苹果在维护这门语言的发展。