...
{% gallery %}
![](https://cdn.dusays.com/2020/06/231-1.jpg/a)
{% endgallery %}
...
{% gallery %}
![](https://cdn.dusays.com/2020/06/232-1.jpg/a)
{% endgallery %}

同样我们在 R2 上增加一条 ACL，然后测试下 C2 可否 Ping 通：

{% gallery %}
![](https://cdn.dusays.com/2020/06/232-2.jpg/a)
{% endgallery %}

最后我们查看一下 R1 路由器的 NAT 转换列表，可以看出多台终端使用一个外网 IP 转发出，但是后面的端口号不同：

{% gallery %}
![](https://cdn.dusays.com/2020/06/232-3.jpg/a)
{% endgallery %}