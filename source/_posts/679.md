...
注意：直接运行 `python GHR.py` 会显示帮助信息。如果扫描 `dusays.com` 站点，命令为 `python GHR.py -u https://dusays.com/`。

## 运行效果

扫描执行过程如下截图：

{% image https://cdn.dusays.com/2024/02/679-1.jpg  ratio:1918/866 %}

## 报告截图

扫描执行结束后会生成报告文档，效果如下截图：

{% image https://cdn.dusays.com/2024/02/679-2.jpg  ratio:1918/866 %}