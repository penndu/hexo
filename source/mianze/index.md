...
{% folding cyan open, 交流社区免责声明 %}

{% radio checked, 交流社区是提供文字、图片发布服务的平台，所有数据均由用户「网友」自行发布并管理的，所有数据作用、性质都与交流社区无关，交流社区对所有数据合法性概不负责，亦不承担任何法律责任； %}
{% radio checked, 如因不可抗力、网络状况、通讯线路、设备故障、第三方网站等任何原因而导致您不能正常使用交流社区，交流社区不承担任何的法律责任； %}
{% radio checked, 您应该对从交流社区获取的数据自行承担风险。除了交流社区注明之外，其它一切因使用从交流社区获取数据而可能遭致的意外、疏忽、侵权及造成的损失，交流社区对其概不负责，亦不承担任何法律责任； %}
{% radio checked, 交流社区严格遵守国家相关法律法规，尊重版权、著作权等权利，因此交流社区不支持包含危害国家安全和民族团结、侵犯他人权益、欺骗性质、色情或暴力的数据； %}
{% radio checked, 交流社区保留自动和人工审查的权利，一旦发现或者接到有效举报，交流社区将在不做任何通知上传者的情况下删除相关的数据，并保留将有关资料提交给相关部门的权利； %}
{% radio checked, 交流社区尊重并保护所有使用交流社区用户的个人隐私，您注册用户名、电子邮件地址个人资料，非经您亲自许可或根据相关法律、法规的强制性规定，交流社区不会主动泄露给第三方。 %}
